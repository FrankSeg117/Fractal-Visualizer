...
void ofApp::draw() {
    ...
    if(debug){
       ...
       dataText.drawString("Press Right Arrow to Level up the Recursion",ofGetWindowWidth()*0.5256,ofGetWindowHeight()*0.0375);
       dataText.drawString("Press Left Arrow to Level down the Recursion",ofGetWindowWidth()*0.5256,ofGetWindowHeight()*0.075);
